...
walkpath = "/home/paso/Documents/Aclai/Datasets/gender_age_recognition/results"
...
for (root, _, files) in walkdir(".")
    for file in files
        ...
        if startswith(file, "spcds") && endswith(file, ".out") && !isfile(string(root, "/features_count.csv"))
