...
#---------------------------------------------------------------------------------------------------#
source_db = [
    # "/home/paso/Documents/Aclai/Datasets/Emotion_databases/MELD.Raw/train/train_splits/",
...
dest_db = ("/home/riccardopasini/Documents/Aclai/Datasets/Common_voice_ds/", "common_voice_ds.csv")
# dest_db = ENV["dest_db"]
